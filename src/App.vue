<template>
  ...
  >
    ...
    <template v-slot="{ user, signOut }">
      ...
      <div>
        <p>&nbsp;</p>
        <p>Congratulations! You have successfully generated a new secure storage bucket and you will soon receive an email with additional credentails.</p>
        ...
        <p style="padding-left: 40px; text-align: left;"><span class="x_ui-provider"><strong>How&nbsp;do&nbsp;I&nbsp;submit&nbsp;my&nbsp;data&nbsp;-&nbsp;Help&nbsp;Guides</strong></span><span class="x_ui-provider">&nbsp;</span></p>
        ...
        <p style="padding-left: 40px; text-align: left;">&nbsp; <span class="x_ui-provider">This includes links to useful software (and guides) for connecting to AWS s3 buckets</span></p>
        <p style="padding-left: 40px; text-align: left;"><span class="x_ui-provider"><strong>What data and formats - Product Specifications</strong></span><span class="x_ui-provider">&nbsp;</span></p>
