  ...
  >
    ...
    <template v-slot="{ user, signOut }">
      ...
      <div>
        ...
        <p style="padding-left: 40px;"><span class="x_ui-provider"><strong>How&nbsp;do&nbsp;I&nbsp;submit&nbsp;my&nbsp;data&nbsp;-&nbsp;Help&nbsp;Guides</strong></span><span class="x_ui-provider">&nbsp;</span></p>
        ...
        <p style="padding-left: 40px;">&nbsp; <span class="x_ui-provider">This includes links to useful software (and guides) for connecting to AWS s3 buckets</span></p>
        <p style="padding-left: 40px;"><span class="x_ui-provider"><strong>What data and formats - Product Specifications</strong></span><span class="x_ui-provider">&nbsp;</span></p>
